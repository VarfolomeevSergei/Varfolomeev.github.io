...
generateLoginButton.addEventListener('click', function(){
    if (ammountOfGeneratedLigins < 5) {
        const adjectives = ['Cool', 'Crazy', 'Awesome', 'Fantastic', 'Epic', '2004_', 'Ultra'];
        const nouns = ['Gamer', 'Ninja', 'Master', 'Champion', 'Wizard', 'Creator','Legend', 'Warrior', 'Genius', 'Hero', 'Sorcerer'];
